            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form  method="post" role="form" action="<?php echo base_url();?>login/checkotp/" id="msform" >
                            <!-- progressbar -->
															...
															<div class="col-lg-6">
															  <div class="card-body p-md-5 mx-md-4" >
																...
																<div class="form-outline mb-4">																    
																	<input type="number" name="userotp" class="form-control" placeholder="Enter Your One Time Password"/ required>																	
																  </div>																  
																  <div class="text-center pt-1 mb-5 pb-1">
																	<button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" >Log in</button>																
																  </div>																 
