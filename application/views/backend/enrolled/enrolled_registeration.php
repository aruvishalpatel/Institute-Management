            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        ...
                        <form  class="form-horizontal form-material" method="post" role="form" id="msform" action="<?php echo base_url();?>login/newenrollment" >
                            <!-- progressbar -->
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>Personal Information</strong></li>
                                <li id="personal"><strong>Document Varification</strong></li> 
											...
											<div class="panel-body table-responsive">
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														...
														<input id="name"  class="form-control"  value="<?php echo set_value('name'); ?>" type="text" name="name"  placeholder="<?php echo get_phrase('fullname');?>" style="width:100%">
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
													    <?php echo form_error('email', '<div class="error" style="color: red;text-align: end;">', '</div>');  ?>
														<input class="form-control" value="<?php echo set_value('email'); ?>"  name="email"  placeholder="<?php echo get_phrase('email');?>" style="width:100%">
													</div>
												</div>  
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input type="date" min="<?php echo $day_before = date( 'Y-m-d', strtotime( '-30years' ) ); ?>" max="<?php echo $day_before = date( 'Y-m-d', strtotime( '-15years' ) ); ?>" value="<?php echo set_value('date_of_birth'); ?>" name="date_of_birth"  placeholder="<?php echo get_phrase('dd-mm-yyyy');?>"  min="1997-01-01" max="2022-12-31" style="width:100%">
													</div>
												</div>
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('gender'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="gender" class="form-control select2"  >
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('category'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="category" class="form-control select2" >
															<option value=""><?php echo get_phrase('select');?></option>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('permanent_address'); ?>" class="form-control"  name="permanent_address"  placeholder="<?php echo get_phrase('address');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('birth_place'); ?>" class="form-control"  name="birth_place"  placeholder="<?php echo get_phrase('birth place');?>" style="width:100%">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('adhar_number'); ?>"   class="form-control"  name="adhar_number" placeholder="<?php echo get_phrase('adhar number ex: 444455557777');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('father_name'); ?>"    class="form-control"  name="father_name"  placeholder="<?php echo get_phrase('father name');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('mother_name'); ?>"   class="form-control"  name="mother_name"  placeholder="<?php echo get_phrase('mother name');?>" style="width:100%">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('mobile_number'); ?>"  " class="form-control"  name="mobile_number" placeholder="<?php echo get_phrase('mobile number');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('jee_rollnumber'); ?>" " class="form-control"  name="jee_rollnumber" placeholder="<?php echo get_phrase('JEE Rollnumber');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('branch'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="branch" class="form-control select2" >
															<option value=""><?php echo get_phrase('select');?></option>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('highschool_passing_year'); ?>"  type="number"   class="form-control"  name="highschool_passing_year" placeholder="<?php echo get_phrase('year of passing high school');?>" style="width:100%">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('inter_passing_year'); ?>" type="number"  class="form-control"  name="inter_passing_year" placeholder="<?php echo get_phrase('year of passing inter');?>" style="width:100%">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('motheroccupation'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="motheroccupation" class="form-control select2" >
															<option value=""><?php echo get_phrase('select');?></option>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('country'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="country" class="form-control select2" >
															<option value=""><?php echo get_phrase('select');?></option>
															<?php
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('state'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="state" class="form-control select2"  >
															<option value=""><?php echo get_phrase('select');?></option>
															<?php 
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('city'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="city" class="form-control select2"  >
															<option value=""><?php echo get_phrase('select');?></option>
															<?php 
															 $this->db->order_by("name", "ASC");                                                          														 
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('general_rank'); ?>" class="form-control" type="number"   name="general_rank" placeholder="<?php echo get_phrase('JEE General Rank');?>" style="width:100%">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<input value="<?php echo set_value('category_rank'); ?>" class="form-control" type="number"   name="category_rank"  placeholder="<?php echo get_phrase('JEE Category Rank');?>" style="width:100%">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12" >
														...
														<select value="<?php echo set_value('blod_group'); ?>" style="padding: 0px 8px 4px 8px; border: none; border-bottom: 1px solid #ccc; border-radius: 0px; margin-bottom: 25px; margin-top: 2px; width: 100%; box-sizing: border-box; font-family: montserrat; color: #2C3E50; font-size: 16px; letter-spacing: 1px;" name="blod_group" class="form-control select2" >
															<option value=""><?php echo get_phrase('select');?></option>
