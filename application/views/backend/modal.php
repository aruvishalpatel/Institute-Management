<script type="text/javascript">
	...
	<script type="text/javascript">
	function confirm_update_modal(update_url)
	{
    ...
    <div class="modal fade" id="modal-5">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
				...
				<div class="row">
				 <div class="col-sm-7">	
				ARE YOU SURE YOU WANT TO ENROLLED THIS STUDENT ?
				</div>
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-success btn-rounded btn-sm" id="update_link"><i class="fa fa-check">&nbsp;</i>YES</a>
