                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4><?php echo $this->db->count_all_results('leave');?></h4>
                                    <span class="text-muted"><?php echo get_phrase('Leave');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4><?php echo $this->db->count_all_results('award');?></h4>
                                    <span class="text-muted"><?php echo get_phrase('Award');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4><?php echo $this->db->count_all_results('vacancy');?></h4>
                                    <span class="text-muted"><?php echo get_phrase('Vacancy');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4><?php echo $this->db->count_all_results('application');?></h4>
                                    <span class="text-muted"><?php echo get_phrase('Application');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
