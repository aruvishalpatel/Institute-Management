...
<div class="panel panel-info">
				...
				<!-- <div class="form-group"> 
					 <div class="col-sm-12">
       				 ...
       				 <img id="blah"  src="<?php //echo base_url();?>uploads/default.jpg" alt="your image" height="150" width="150"/ style="border:1px dotted red">
	...
	<div class="form-group">
                    ...
                    <div class="col-sm-12">
							<select name="transport_id" class="form-control select2" style="width:100%">
                              <option value=""><?php echo get_phrase('select');?></option>
	                              <?php 
	                              	$transports = $this->db->get('transport_route')->result_array();
	                              	foreach($transports as $row):
	                              ?>
                              		<option value="<?php echo $row['transport_route_id'];?>"><?php echo $row['name'];?></option>
                          		<?php endforeach;?>
                          </select>
	<a href="<?php echo base_url();?>transportation/transport_route/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
