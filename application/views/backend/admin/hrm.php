    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New Human Resource');?>
	<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add <?php echo get_phrase('New Human Resource');?> here<i class="btn btn-primary btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
    <div class="panel-wrapper collapse out" aria-expanded="true">
                        <div class="panel-body">

                        <?php echo form_open(base_url() . 'admin/hrm/insert/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="hidden" name="hrm_number" value="<?php echo substr(md5(uniqid(rand(), true)), 0, 10);?>"class="form-control">
                        </div>
                    </div>
...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_hostel_manager');?></div>
                    ...
                    <tbody>
                        ...
                        <?php $count =1; foreach($select_hrm as $key => $hrm):	?>	
                               
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $hrm['name'];?></td>
                            <td><?php echo $hrm['email'];?></td>
                            <td><?php echo $hrm['sex'];?></td>
                            <td><?php echo $hrm['address'];?></td>
                            <td>
                            
                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_hrm/<?php echo $hrm['hrm_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>admin/hrm/delete/<?php echo $hrm['hrm_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
