...
<?php if($class_id > 0 && $student_id > 0 && $exam_id > 0):?>	
	...
	<div class="col-sm-12">
        ...
        <?php $select_sunject_with_class_id  =   $this->crud_model->get_subjects_by_class($class_id);
            foreach ($select_sunject_with_class_id as $key => $class_subject_exam_student): 
                ...
                foreach ($update_subject_marks as $key => $general_select):
                    ...
                    $sum_all_classes_and_exam_score=$general_select['class_score1']+
                    $general_select['class_score2']+$general_select['class_score3']+$general_select['exam_score'];
        ...
        ?>
                ...
                <a href="<?php echo base_url().'admin/print_mass_report_card/' . $class_id . '/' . $exam_id;?>">
                    <button class="btn btn-success btn-rounded btn-sm btn-block"><?php echo get_phrase('Mass Report') ;?></button>
                </a>    
