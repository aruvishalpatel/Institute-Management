    ...
    <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->dashboard;?>
                    ...
                    <?php endif;?>    
                      ...
                      <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_academics;?>
                    <?php if($check_admin_permission == '1'):?>                       
       ...
       <li class="<?php if ($page_name == 'enquiry') echo 'active'; ?> ">
        ...
        <li class="<?php if ($page_name == 'club') echo 'active'; ?>">
                ...
                <i class="fa fa-angle-double-right p-r-10"></i>
                      <span class="hide-menu"><?php echo get_phrase('clubs'); ?></span>
                </a>
        </li>
    ...
    <?php endif;?>  
      ...
      <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_employee;?>
    <?php if($check_admin_permission == '1'):?>
    ...
    <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_student;?>
    <?php if($check_admin_permission == '1'):?>             
...
if ($page_name == 'new_student' ||
	...
	$page_name == 'new_enrolled_student' ||
    $page_name == 'student_promotion')
echo 'opened active has-sub';
?> ">

    <li class="<?php if ($page_name == 'new_enrolled_student') echo 'active'; ?> ">
        <a href="<?php echo base_url(); ?>admin/new_enrolled_student">
        <i class="fa fa-angle-double-right p-r-10"></i>
              <span class="hide-menu"><?php echo get_phrase('enrolled_student'); ?></span>
        </a>
    </li>
...
<?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_attendance;?>
<?php if($check_admin_permission == '1'):?>
<li class="attendance"> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-hospital-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('manage_attendance');?><span class="fa arrow"></span></span></a>
            ...
            <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->learning_material;?>
<?php if($check_admin_permission == '1'):?>        

        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-download p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('E-Learning-Material');?><span class="fa arrow"></span></span></a>
           ...
           <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_parent;?>
<?php if($check_admin_permission == '1'):?>  
...
<?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_alumni;?>
<?php if($check_admin_permission == '1'):?>  
...
<?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->class_information;?>
<?php if($check_admin_permission == '1'):?>  
            ...
            ?>">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_subject;?>
<?php if($check_admin_permission == '1'):?>  
                        ...
                        <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_exams;?>
<?php if($check_admin_permission == '1'):?>  
        ...
        ?>">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->report_card;?>
<?php if($check_admin_permission == '1'):?>  
            ...
            ?>">
                    ...
                    <li class="<?php if ($page_name == 'tabulation_sheet') echo 'active'; ?> ">
                        ...
                        <i class="fa fa-angle-double-right p-r-10"></i>
                            <span class="hide-menu"><?php echo get_phrase('terminal_report'); ?></span>
                        </a>
                    </li>
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->fee;?>
<?php if($check_admin_permission == '1'):?>  
...
<li class="<?php if ($page_name == 'student_payment') echo 'active'; ?> ">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->hrm;?>
<?php if($check_admin_permission == '1'):?> 
     ...
     <li class="<?php if ($page_name == 'leave') echo 'active'; ?> ">
           ...
           // if ($page_name == 'expense' ||
            ...
            ?> ">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->hostel;?>
<?php if($check_admin_permission == '1'):?>            
...
<?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->communications;?>
<?php if($check_admin_permission == '1'):?> 
<li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-envelope p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('communications');?><span class="fa arrow"></span></span></a>
        ...
        <li class="<?php if ($page_name == 'sendEmailMessage') echo 'active'; ?> ">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->transportation;?>
<?php if($check_admin_permission == '1'):?> 
            ...
            ?>">
                ...
                <?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->setting;?>
<?php if($check_admin_permission == '1'):?> 
...
<?php $check_admin_permission = $this->db->get_where('admin', array('admin_id' => $this->session->userdata('login_user_id')))->row()->generate_report;?>
<?php if($check_admin_permission == '1'):?> 
<li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('generate_reports');?><span class="fa arrow"></span></span></a>
                ...
                <!-- <li class="<?php //if (isset($report_type) && $report_type == 'studentPaymentReport') echo 'active';?>">
