<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New Hostel Manager');?>
	<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add <?php echo get_phrase('New Hostel Manager');?> here<i class="btn btn-primary btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
    <div class="panel-wrapper collapse out" aria-expanded="true">
                    ...
                    <div class="col-sm-12">
                            ...
                            <input type="hidden" name="hostel_number" value="<?php echo substr(md5(uniqid(rand(), true)), 0, 10);?>"class="form-control">
                        </div>
                    </div>
...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <?php $count =1; foreach($select_hostel as $key => $hostel):	?>	
                               
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $hostel['name'];?></td>
                            <td><?php echo $hostel['email'];?></td>
                            <td><?php echo $hostel['sex'];?></td>
                            <td><?php echo $hostel['address'];?></td>
                            <td>
                            
                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_hostel/<?php echo $hostel['hostel_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a onclick="confirm_modal('<?php echo base_url();?>admin/hostel/delete/<?php echo $hostel['hostel_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
