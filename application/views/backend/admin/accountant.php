...
<div class="row">
                    ...
                    <tbody>
                        ...
                        <?php $count =1; foreach($select_accountant as $key => $accountant):	?>	
                        ...
                        <tr>
                            ...
                            <a onclick="confirm_modal('<?php echo base_url();?>admin/accountant/delete/<?php echo $accountant['accountant_id'];?>')" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
