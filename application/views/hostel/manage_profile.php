	...
	<div class="col-sm-7">
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<?php echo form_open(base_url(). 'hostel/manage_profile/update', array('class' => 'form-horizontal form-groups-bordered', 'enctype'=> 'multipart/form-data'));?>
				...
				<!-- <div class="form-group"> 
					 <label class="col-sm-12"><?php //echo get_phrase('hostel Image');?>*</label>        
					 <div class="col-sm-12">
  		  			 <input type='file' class="form-control" name="userfile" onChange="readURL(this);">
					 <img id="blah" src="<?php //echo $this->crud_model->get_image_url('hostel', $row['hostel_id']); ?>" alt="" height="200" width="200"/>
					</div>
					</div>	 -->
...
<?php echo form_open(base_url() . 'hostel/manage_profile/change_password', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
        ?>			
					<div class="form-group">
